...
<html lang="en">
  <head>
    ...
    <title>ADMIN UPDATE SENATE STAFF</title>
  </head>
  ...
  <ul class="nav justify-content-center">
       <li class="nav-item">
    <a class="nav-link disabled" aria-current ="page">Senate Update Personnel Page</a>
  </li>
  <!-- <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="#">Active</a>
  </li> -->
  <li class="nav-item">
    <a class="nav-link" href="deletesenate.php">Delete</a>
  </li>
  <li class="nav-item">
