...
if($result) {
  ...
  header('Location: http://localhost/bolaji/admin/master/index.php');
      ...
      <div class="">
        <form  method="post">
          ...
          <p>Gender</p>
              ...
              <div class="input_field select_option">
                <select name="position" crequired> 
          ...
          <input class="button" type="submit" name="submit" value="Create Personnel"   />
        </form>
      </div>
    </div>
  </div>
